...
local MODES = {
  { id = "local", title = "On this device",
    note = "Trade between two saves on this device." },
  { id = "remote", title = "Over the internet",
    note = "Trade with another trainer over the relay." },
}
